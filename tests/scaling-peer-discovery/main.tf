...
data "docker_registry_image" "rosenet-node" {
  name = "ghcr.io/rosen-bridge/scaling-peer-discovery-test-node"
}

data "docker_registry_image" "rosenet-relay" {
  name = "ghcr.io/rosen-bridge/scaling-peer-discovery-test-relay"
}
...
resource "docker_container" "rosenet-node-0" {
  ...
  env = [
    "RELAY_MULTIADDR=/ip4/${var.relay-ip}/tcp/33333/p2p/${local.relay_peer_id}", "PRIVATE_KEY=${local.node_private_keys[count.index]}"]
...
resource "docker_container" "rosenet-node-1" {
  ...
  env = [
    "RELAY_MULTIADDR=/ip4/${var.relay-ip}/tcp/33333/p2p/${local.relay_peer_id}", "PRIVATE_KEY=${local.node_private_keys[count.index + 4]}"]
...
resource "docker_container" "rosenet-node-2" {
  ...
  env = [
    "RELAY_MULTIADDR=/ip4/${var.relay-ip}/tcp/33333/p2p/${local.relay_peer_id}", "PRIVATE_KEY=${local.node_private_keys[count.index + 8]}"]
...
resource "docker_container" "rosenet-node-3" {
  ...
  env = [
    "RELAY_MULTIADDR=/ip4/${var.relay-ip}/tcp/33333/p2p/${local.relay_peer_id}", "PRIVATE_KEY=${local.node_private_keys[count.index + 12]}"]
...
resource "docker_container" "rosenet-node-4" {
  ...
  env = [
    "RELAY_MULTIADDR=/ip4/${var.relay-ip}/tcp/33333/p2p/${local.relay_peer_id}", "PRIVATE_KEY=${local.node_private_keys[count.index + 16]}"]
...
resource "docker_container" "rosenet-node-5" {
  ...
  env = [
    "RELAY_MULTIADDR=/ip4/${var.relay-ip}/tcp/33333/p2p/${local.relay_peer_id}", "PRIVATE_KEY=${local.node_private_keys[count.index + 20]}"]
...
resource "docker_container" "rosenet-node-6" {
  ...
  env = [
    "RELAY_MULTIADDR=/ip4/${var.relay-ip}/tcp/33333/p2p/${local.relay_peer_id}", "PRIVATE_KEY=${local.node_private_keys[count.index + 24]}"]
...
resource "docker_container" "rosenet-node-7" {
  ...
  env = [
    "RELAY_MULTIADDR=/ip4/${var.relay-ip}/tcp/33333/p2p/${local.relay_peer_id}", "PRIVATE_KEY=${local.node_private_keys[count.index + 28]}"]
...
resource "docker_container" "rosenet-node-8" {
  ...
  env = [
    "RELAY_MULTIADDR=/ip4/${var.relay-ip}/tcp/33333/p2p/${local.relay_peer_id}", "PRIVATE_KEY=${local.node_private_keys[count.index + 32]}"]
...
resource "docker_container" "rosenet-node-9" {
  ...
  env = [
    "RELAY_MULTIADDR=/ip4/${var.relay-ip}/tcp/33333/p2p/${local.relay_peer_id}", "PRIVATE_KEY=${local.node_private_keys[count.index + 36]}"]
